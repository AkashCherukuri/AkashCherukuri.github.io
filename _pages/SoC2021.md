...
- **AlexNet**
	...
	{% include figure image_path="/assets/images/Soc2021/AlexNet_Est.png" caption="Classification by **Modified** Alexnet" %}
...
- **VGG**
	...
	{% include gallery id="galleryvgg" caption="Training and Evaluation of **modified** VGG Net" %}
