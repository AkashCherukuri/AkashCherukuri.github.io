...
- **AlexNet**
	...
	{% include figure image_path="/assets/images/Soc2021/AlexNet_Est.png" %}
...
- **VGG**
	...
	[This](https://github.com/AkashCherukuri/Image-Colorization/blob/main/VGGNet.py) is my implementation of VGGNet, and the results are shown below.
	 ...
	 <div class="row">
		  <div class="column">
			  <figure>
				  <img src="/assets/images/Soc2021/VGGNet_Res.png">
				  <figcaption>Loss vs Epochs for modified VGG Net</figcaption>
			  </figure>
		  </div>
		  <div class="column">
		  	<figure>
			  <img src="/assets/images/Soc2021/VGGNet_Est.png">
			  <figcaption>Classification of data after training</figcaption>
		   </figure>
		  </div>
	  </div>
